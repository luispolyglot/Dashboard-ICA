...
begin
  ...
  -- Unlock when the user already has enough progress in either window.
  -- This avoids UI contradictions (e.g. 21/20 shown but still locked).
  progress_unlock := previous_unlock_count >= 20 or current_progress_count >= 20;
